...
## ♾️ DevOps: 
[![My Skills](https://skillicons.dev/icons?i=docker,kubernetes,linux,nginx,notion,postman,stackoverflow)](https://skillicons.dev)
...
## 🥷 💪 🏋️:
[![My Skills](https://skillicons.dev/icons?i=aws,babel,bitbucket,bootstrap,cloudflare,bots,django,express,fastapi,figma,flask,github,postgres,prisma,py,redis,redux,sass,sqlite,tailwind,ts,ubuntu,vercel,webpack)](https://skillicons.dev)
