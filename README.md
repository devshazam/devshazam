...
## ♾️ DevOps: 
[![My Skills](https://skillicons.dev/icons?i=linux,nginx,notion,postman,stackoverflow)](https://skillicons.dev)
...
## SaaS
[![My Skills](https://skillicons.dev/icons?i=firebase,gcp,gitlab,mongodb,supabase)](https://skillicons.dev)

## 🥷 💪 🏋️:
[![My Skills](https://skillicons.dev/icons?i=aws,babel,bitbucket,bootstrap,cloudflare,express,figma,github,postgres,prisma,py,redis,redux,sass,sqlite,tailwind,ts,ubuntu,vercel,webpack)](https://skillicons.dev)
...
### I used it once:
[![My Skills](https://skillicons.dev/icons?i=arduino,gulp,jquery,laravel,less,mysql,pug,raspberrypi,flask,fastapi,bots,django)](https://skillicons.dev)
